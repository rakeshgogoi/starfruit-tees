                ...
                <div key={product.id} className="relative group">
                  ...
                  <div className="px-0.5 sm:px-1">
                      ...
                      {(() => {
                        ...
                        return (
                          <>
                            ...
                            {label && (
                              <span className="text-[10px] font-black uppercase bg-yellow-400 text-black px-1.5 py-0.5 rounded-full leading-none">{label}</span>
                            )}
                          </>
                        );
                      })()}
                    ...
                    <Link
                      ...
                      className="w-full bg-black text-white py-2 sm:py-2.5 rounded-full font-semibold text-[10px] sm:text-xs uppercase tracking-wide flex items-center justify-center gap-1.5 hover:bg-yellow-400 hover:text-black transition-all mb-2"
                    >
